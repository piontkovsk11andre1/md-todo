...
const LOCALIZABLE_TEMPLATES: ReadonlyArray<{ fileName: string; fallback: string }> = [
  ...
  { fileName: "migrate-context.md", fallback: DEFAULT_MIGRATE_CONTEXT_TEMPLATE },
  { fileName: "migrate-snapshot.md", fallback: DEFAULT_MIGRATE_SNAPSHOT_TEMPLATE },
  { fileName: "migrate-backlog.md", fallback: DEFAULT_MIGRATE_BACKLOG_TEMPLATE },
  { fileName: "migrate-review.md", fallback: DEFAULT_MIGRATE_REVIEW_TEMPLATE },
  { fileName: "migrate-ux.md", fallback: DEFAULT_MIGRATE_USER_EXPERIENCE_TEMPLATE },
