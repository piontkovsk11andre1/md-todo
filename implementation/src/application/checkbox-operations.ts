...
const RUNTIME_STALE_CHILD_LABEL_PATTERN = /^(?:total time|execution|verify|repair|idle|tokens estimated|phases|verify attempts|repair attempts|skip|skipped|answer|get-result|memory-result|for-item|for-current):(?:\s+\S.*)?$/i;
