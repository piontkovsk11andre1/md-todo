...
describe("createLoggedOutputPort", () => {
  ...
  it("logs expected level, stream, kind, and message for every event kind", () => {
    ...
    const events = [
      { kind: "info", message: "info message" } as const,
      { kind: "warn", message: "warn message" } as const,
      { kind: "error", message: "error message" } as const,
      { kind: "success", message: "success message" } as const,
      {
        kind: "task",
        task: {
      ...
      { kind: "text", text: "plain text" } as const,
      { kind: "stderr", text: "stderr text" } as const,
    ];
